...
exports.getConversationController = exports.getConversationsController = exports.createConversationController = void 0;
...
async function getConversationsController(req, res) {
    const { userId } = req.body.login.data.id;
    if (!userId) {
        throw new HttpException_1.default(401, 'User id is required');
    }
